...
const Promotion_date = () => {
    ...
    const handleClick = async (e) => {
        await axios.post(`http://165.232.70.6:7000/api/promotion_date/create`,{
    ...
    const deletePromotion = async (id) => {
        await axios.delete(`http://165.232.70.6:7000/api/promotion_date/${id}`)
        fetch_promotion()
    }

    const updatePromotion = async (id) => {
        await axios.put(`http://165.232.70.6:7000/api/promotion_date/${id}`,{
            promotion_name: promotion_name,
            promotion_date: promotion_date
        })
        fetch_promotion()

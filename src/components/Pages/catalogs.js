...
function Catalogs() {
    ...
    const handleClick = async (e) => {
        ...
        await axios.post('http://165.232.70.6:7000/api/catalog/create', formdata)
        FetchData()
    }
    ...
    const getData = async (id) => {
        const data = await axios.get(`http://165.232.70.6:7000/api/catalog/${id}`)
        const ResData = await data.data
        const newobject = {id: ResData._id, title: ResData.name, file: `http://165.232.70.6:7000/catalogs/${ResData.image[0]}`}
    ...
    const deleteHandler = async (e) => {
        e.preventDefault()
        await axios.delete(`http://165.232.70.6:7000/api/catalog/${id}`)
        FetchData()
    }
    ...
    const handleSubmit = async (e) => {
        ...
        console.log(getdata)
        await axios.put(`http://165.232.70.6:7000/api/catalog/${getdata.id}`, formdata)
        FetchData()
    }
            ...
            <div className={"container mt-5 w-50"}>
                    ...
                    <table className="table table-dark ">
                        ...
                        <tr>
                            ...
                            <td>{item.name}</td>
                            <td><img src={`http://165.232.70.6:7000/catalogs/${item.image}`} style={{width: "50px", height: "50px"}}/></td>
                            <td>

...
function Material() {
    ...
    const handleClick = async (e) => {
        ...
        await axios.post('http://165.232.70.6:7000/api/material/create', formdata)
        FetchData()
    }
    ...
    const deleteHandler = async (e) => {
        e.preventDefault()
        await axios.delete(`http://165.232.70.6:7000/api/material/${id}`)
        FetchData()
    }


    // const getHandler = async () => {
    //     const { data } = await axios.get(`http://localhost:5000/api/material/${id}`)
    //     console.log(data)
    // }
    // getHandler()
                    ...
                    {materials.map((item, index) => {
                        return (
                            ...
                            <tr>
                                ...
                                <td><img src={`http://165.232.70.6:7000/materials/${item.image}`} style={{width: "50px", height: "50px"}}/></td>
                                <td>

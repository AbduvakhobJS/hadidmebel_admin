...
function PromotionProducts() {
    ...
    const addPromotion = async (e) => {
        ...
        await axios.post(`http://165.232.70.6:7000/api/promotion/create`, formdata)
        fetchData()
    }
    ...
    const deletePromotion = async (e) => {
        e.preventDefault()
        await axios.delete(`http://165.232.70.6:7000/api/promotion/${id}`)
        fetchData()
    }
                ...
                <table className="table table-dark">
                    ...
                    {promotion.map((item, index) => (
                        ...
                        <tr>
                            ...
                            <td>
                                <img src={`http://165.232.70.6:7000/promotions/${item.image}`} style={{width: "50px", height: "50px"}}/>
                            </td>
                            <td>
